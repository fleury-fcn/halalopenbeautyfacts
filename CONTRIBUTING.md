# Contributing to Halal Open Beauty Facts

First off, thank you for considering contributing to **Halal Open Beauty Facts**! 💄☪️

This project exists to help people around the world find trustworthy information about halal-certified cosmetics and personal care products. Whether you're fixing a bug, improving documentation, adding a translation, or curating product data — every contribution matters.
...
- **📊 Curate product data** — Help identify and flag halal-certified or non-compliant cosmetic products through the platform itself.
...
git clone https://github.com/YOUR_USERNAME/halalopenbeautyfacts.git
cd halalopenbeautyfacts

# 2. Add the original repository as an upstream remote
git remote add upstream https://github.com/halalopenfoodfacts-server/halalopenbeautyfacts.git
...
If anything is unclear, open an issue with the `question` label, or reach out via [contact@halalopenbeautyfacts.org](mailto:contact@halalopenbeautyfacts.org).
...
Thank you again for helping make halal cosmetics certification more transparent for everyone. 🙏
